...
- **[`docs/CONOPS.md`](docs/CONOPS.md)** — what the ontology is for, who uses it, the two kinds of entry (a rule, whose meaning is the regulation's, and a definition, whose meaning is the ontology's), how far a search goes, and what an edition promises a consumer. Proposed.
